...
serve(async (req) => {
  ...
  try {
    ...
    for (const member of members) {
      ...
      const suppressForQuietHours = shouldSuppressForQuietHours(recipientPrefs, notificationType);
...
<a href="${appUrl}" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #00B7E8 0%, #00D1FF 100%); color: #ffffff; font-size: 17px; font-weight: 700; text-decoration: none; padding: 16px 48px; border-radius: 50px; font-family: 'Heebo', Arial, sans-serif;">&#x2192; לאישור ההוצאה</a>
</td>
</tr>
</table>
