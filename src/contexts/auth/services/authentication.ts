...
export async function register(name: string, email: string, password: string, verificationMethod?: string, phoneNumber?: string) {
  return userService.register(name, email, password, verificationMethod, phoneNumber);
}
