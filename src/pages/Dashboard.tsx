...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 animate-fade-in">
      {/* Header with Logo and Characters */}
      <div className="w-full bg-background/95 backdrop-blur-sm border-b border-border/50 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Logo size="sm" />
          </div>
          <div className="flex items-center gap-2">
            <CharacterImage variant="happy" size="sm" />
            <CharacterImage variant="excited" size="sm" />
          </div>
        </div>
      </div>
