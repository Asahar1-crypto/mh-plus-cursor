...
export const ChildrenExpensesChart: React.FC<ChildrenExpensesChartProps> = ({ periodFilter, billingDay = 1 }) => {
  ...
  const SummaryStats = () => (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
      ...
      <div className="text-center p-2.5 sm:p-3.5 bg-gradient-to-br from-indigo-500/10 to-blue-500/10 rounded-xl border border-indigo-200/30 dark:border-indigo-800/30 hover:border-indigo-400/50 transition-colors duration-300">
        <div className="p-1.5 bg-indigo-500/15 rounded-lg w-fit mx-auto mb-1.5">
      ...
      <div className="text-center p-2.5 sm:p-3.5 bg-gradient-to-br from-pink-500/10 to-rose-500/10 rounded-xl border border-pink-200/30 dark:border-pink-800/30 hover:border-pink-400/50 transition-colors duration-300">
        <div className="p-1.5 bg-pink-500/15 rounded-lg w-fit mx-auto mb-1.5">
      ...
      <div className="text-center p-2.5 sm:p-3.5 bg-gradient-to-br from-orange-500/10 to-amber-500/10 rounded-xl border border-orange-200/30 dark:border-orange-800/30 hover:border-orange-400/50 transition-colors duration-300">
        <div className="p-1.5 bg-orange-500/15 rounded-lg w-fit mx-auto mb-1.5">
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="text-center py-8 sm:py-12 text-muted-foreground">
            <div className="p-4 bg-muted/30 rounded-full w-fit mx-auto mb-4">
              <Users className="h-10 w-10 sm:h-12 sm:w-12 opacity-50" />
            </div>
  ...
  return (
    <Card className="bg-card border border-border/50 shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-accent/5 to-primary/10 pointer-events-none"></div>

      <CardHeader className="relative z-10 p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3 sm:gap-4">
          <div className="space-y-1 sm:space-y-2">
            <CardTitle className="flex items-center gap-2 sm:gap-3 text-lg sm:text-xl">
              <div className="p-1.5 sm:p-2 bg-gradient-to-br from-accent/20 to-accent/10 rounded-xl border border-accent/20">
                <Users className="h-4 w-4 sm:h-5 sm:w-5 text-accent" />
              </div>
