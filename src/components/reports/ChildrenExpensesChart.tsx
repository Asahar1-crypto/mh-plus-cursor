      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-12 text-muted-foreground">
            ...
            <p className="text-sm">הוסף הוצאות כדי לראות את החלוקה לפי ילדים</p>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardContent>
        <Tabs defaultValue="pie" className="space-y-4">
          ...
          <TabsContent value="bar" className="space-y-4">
            <ResponsiveContainer width="100%" height={400}>
              <BarChart data={childrenData} margin={{ top: 20, right: 30, left: 20, bottom: 5 }}>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              ...
              <div className="text-center p-3 bg-muted/50 rounded-lg">
                ...
                <div className="text-sm text-muted-foreground">ילדים פעילים</div>
              </div>
              <div className="text-center p-3 bg-muted/50 rounded-lg">
